...
var FeedbacksService = (function () {
    function FeedbacksService(feedbacksService) {
        this.feedbacksService = feedbacksService;
        this.feedbacksApi = 'api/feedbacks/all';
        this.createFeedbackApi = 'api/feedbacks/create';
        this.pageSize = 4;
    }
    FeedbacksService.prototype.getFeedbacks = function (page) {
        return this.feedbacksService.getByPage(this.feedbacksApi, page, this.pageSize);
    };
    ;
    FeedbacksService.prototype.createFeedback = function (newFeedback) {
